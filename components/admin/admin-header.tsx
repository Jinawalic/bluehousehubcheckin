    ...
    <header className="relative z-30 px-4 py-4 sm:px-8 sm:py-5 lg:px-12 lg:py-6">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#8f2bd4] via-[#c342df] to-[#ff6c9b] shadow-[0_8px_20px_rgba(174,76,207,0.24)]">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#6d6a7e]">{adminUser?.email || currentTabInfo.subtitle}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            type="button"
            onClick={onExportCSV}
            className="hidden items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-xs transition-all hover:bg-purple-50 hover:text-purple-700 active:scale-95 sm:inline-flex"
          >
          ...
          <button
            ...
            className="hidden items-center gap-1.5 rounded-xl bg-[#7b2bc7] px-3.5 py-2 text-xs font-semibold text-white shadow-xs transition-all hover:bg-[#6821aa] active:scale-95 sm:inline-flex"
          >
          ...
          <button
            type="button"
            onClick={onLogout}
            className="inline-flex items-center gap-2 rounded-full border border-[#e3e1ed] bg-white/70 px-4 py-2.5 text-sm font-semibold text-[#171429] shadow-[0_2px_6px_rgba(72,67,110,0.08)] transition hover:bg-white"
          >
